...
(function($) {
   ...
   */
  function ProgressMeter(canvas, progress, options) {
    var defaults = {
      duration: 1200,
      fill: '#C1D4A1',
      background: '#EFEFEF',
...
$(document).ready(function() {
  ...
  var bg1 = document.getElementById('counter1');
  var bg2 = document.getElementById('counter2');
  var bg3 = document.getElementById('counter3');

  var $progress = $('.progress')
  var green = new ProgressMeter(bg, 86, { fill: COLOURS.GREEN, text: $progress[0] });
  var pink = new ProgressMeter(bg1, 43, { fill: COLOURS.PINK, text: $progress[1] });
  var orange = new ProgressMeter(bg2, 66, { fill: COLOURS.ORANGE, text: $progress[2] });
  vae blue = new ProgressMeter(bg3, 18, { fill: COLOURS.BLUE, text: $progress[3] });
});
